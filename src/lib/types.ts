...
export const ANIME_GENRES: GenreConfig[] = [
  ...
  { id: 4,  name: "Comedy",          type: "genre", description: "Юмор, шутки и лёгкая атмосфера для поднятия настроения." },
  { id: 8,  name: "Drama",           type: "genre", description: "Глубокие эмоции, конфликты и серьёзные переживания героев." },
  { id: 9,  name: "Ecchi",           type: "genre", description: "Пикантные ситуации и акцент на привлекательности персонажей." },
  { id: 49, name: "Erotica",         type: "genre", description: "Откровенное содержание, выходящее за рамки Ecchi." },
  ...
  { id: 61, name: "Idols (Male)",    type: "genre", description: "Мужские группы идолов и шоу-бизнес." },
  ...
  { id: 74, name: "Love Status Quo", type: "genre", description: "Сохранение статус-кво в любовных отношениях — никто не признаётся первым." },
  ...
  { id: 67, name: "Medical",         type: "genre", description: "Врачи, больницы и спасение жизней." },
  ...
  { id: 70, name: "Performing Arts", type: "genre", description: "Театр, актёрское мастерство и выступления на сцене." },
  ...
  { id: 23, name: "School",          type: "genre", description: "Школьная жизнь, учёба и взросление." },
  ...
  { id: 82, name: "Urban Fantasy",   type: "genre", description: "Магия и фантастика в современном городском мире." },
  ...
  { id: 83, name: "Villainess",      type: "genre", description: "Главная героиня оказывается в роли злодейки в другом мире." },
  { id: 80, name: "Visual Arts",     type: "genre", description: "Рисование, живопись и изобразительное искусство." },
  { id: 48, name: "Workplace",       type: "genre", description: "В центре сюжета рабочее место и профессиональная деятельность." },
  // ── Demographics ─────────────────────────────────────────────────────────
  { id: 43, name: "Josei",           type: "genre", description: "Аниме, ориентированное на взрослых женщин." },
  { id: 15, name: "Kids",            type: "genre", description: "Аниме для самых маленьких зрителей." },
  { id: 42, name: "Seinen",          type: "genre", description: "Аниме, ориентированное на взрослых мужчин." },
  { id: 25, name: "Shoujo",          type: "genre", description: "Аниме для девочек-подростков, часто с романтикой." },
  { id: 27, name: "Shounen",         type: "genre", description: "Аниме для мальчиков-подростков, часто с боёвкой и дружбой." },
];
